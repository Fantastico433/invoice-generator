...
const translations = {
  et: {
    ...
    reverseChargeNote: 'Pöördmaksustamine — käibemaksu tasub kauba või teenuse saaja (Direktiiv 2006/112/EÜ artikkel 196).',
  ...
  en: {
    ...
    reverseChargeNote: 'Reverse charge — VAT to be accounted for by the recipient (Directive 2006/112/EC, Article 196).',
